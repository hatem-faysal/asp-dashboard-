...
namespace testcrud.Migrations
{
    ...
    [Migration("20250128115621_AddRecruitmentTable")]
    partial class AddRecruitmentTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("testcrud.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("testcrud.Models.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("testcrud.Models.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("testcrud.Models.PublicUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("testcrud.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("testcrud.Models.City", b =>
                {
                    b.HasOne("testcrud.Models.Country", "Country")
                        .WithMany()
            ...
            modelBuilder.Entity("testcrud.Models.Product", b =>
                {
                    b.HasOne("testcrud.Models.Category", "Category")
                        .WithMany("Products")
